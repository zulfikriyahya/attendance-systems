...
<body>
    ...
    <h1>Verifikasi Laporan Presensi Siswa</h1>
    <div class="info" style="overflow-x: auto; padding: 16px; background: #fff; margin-bottom: 20px;">
        ...
        <table style="font-size: 13px; border-collapse: collapse; border: none;">
            <tr>
                ...
                <td style="border: none;">: {{ $siswa->user->name }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none;">: {{ $siswa->kelas->nama ?? '-' }}</td>
            </tr>
            <tr>
    ...
    <div class="footer">
        Dicetak Otomatis oleh Sistem Presensi {{ $siswa->jabatan->instansi->nama ?? 'Madrasah' }}.
