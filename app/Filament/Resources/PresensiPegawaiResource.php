...
use App\Jobs\PenetapanHadirPegawaiJob;
use App\Jobs\PenetapanLiburPegawaiJob;
use App\Jobs\PenetapanCutiJob;
...
class PresensiPegawaiResource extends Resource
{
    ...
    protected static ?string $slug = 'presensi-pegawai';
            ...
            ->headerActions([
                ...
                Action::make('set-hadir')
                    ...
                    ->action(function (array $data) {
                        ...
                        PenetapanHadirPegawaiJob::dispatch($data);
                ...
                Action::make('set-libur')
                    ...
                    ->action(function (array $data) {
                        // Dispatch job ke queue
                        PenetapanLiburPegawaiJob::dispatch($data);
                ...
                Action::make('set-cuti')
                    ...
                    ->action(function (array $data) {
                        // Dispatch job ke queue
                        PenetapanCutiJob::dispatch($data);

                        // Notifikasi bahwa job telah dijadwalkan
                        Notification::make()
                            ->title('Penetapan Cuti Dijadwalkan')
                            ->body('Proses penetapan cuti telah dijadwalkan dan akan dijalankan di background.')
                            ->info()
                            ->send();
                    })
                    ->visible(fn() => Auth::user()->hasRole('super_admin')),
